...
import type { GovUKTagAspectProps, GovUKMandatoryAppTags, GovUKOptionalAppTags } from '../../src/gov-uk-tag.types';
 ...
 */
export function synthAndAssertHasError(app: App, stack: Stack, pattern: string): void {
  app.synth();
  const annotations = Annotations.fromStack(stack);
